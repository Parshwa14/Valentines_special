...
function changeButtonColor(button) {
    if (button.id === 'yesButton') {
        button.style.backgroundColor = '#ff66b2'; // Soft pink for Yes button
        button.style.color = '#fff'; // White text
    } else if (button.id === 'noButton') {
        button.style.backgroundColor = '#ff3385'; // Slightly darker pink for No button
        button.style.color = '#fff'; // White text
    }

    // Apply some animation for smooth color transition
